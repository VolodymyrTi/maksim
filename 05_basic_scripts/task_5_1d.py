...
parameter_list = str (list(london_co[device_name].keys())).replace("\'","").strip("[]")
parameter=input("Введите имя параметра ("+parameter_list+"):")
print(london_co[device_name].get(parameter.lower(),"Такого параметра нет"))
